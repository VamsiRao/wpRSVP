...
<div class="container">
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-6 col-xs-12" >
				<div id="events_carousel" class="carousel slide" data-ride="carousel" style="margin-top: 50px">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img  src="<?php echo get_template_directory_uri(); ?>/soiree1.jpg" alt="1">
						</div>
						<div class="item">
							<img src="<?php echo get_template_directory_uri(); ?>/soiree2.jpg" alt="2">
						</div>
						<div class="item">
							<img src="<?php echo get_template_directory_uri(); ?>/soiree3.jpg" alt="3">
						</div>
					</div>
					<a class="left carousel-control" href="#events_carousel" data-slide="prev">
						<span class="glyphicon glyphicon-chevron-left"></span>
						<span class="sr-only">Previous</span>
					</a>
					<a class="right carousel-control" href="#events_carousel" data-slide="next">
